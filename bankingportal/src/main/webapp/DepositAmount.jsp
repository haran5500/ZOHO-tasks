...
<body>
	...
	<div class="div">
		<form action="deposit" method="post" id="transferform"
			onsubmit="return validateDptForm();">
			<fieldset>
				...
				<table class="wdltable">
					...
					<tr>
						<td><input type="text" name="amount" min="1" maxlength="10"
							...
							placeholder="Amount to be Deposited" id="amount"></td>
					</tr>
					<tr>
					...
					<tr>
						<td><input type="button" name="Reset" value="Reset"
							...
							type="submit" name="DepositAmount" value="Deposit Amount"
							class="submitbtn"></td>
					</tr>
