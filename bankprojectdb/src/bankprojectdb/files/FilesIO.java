...
public class FilesIO {
	...
	public static boolean validateFileExists(File inpFileObj) {
		return inpFileObj.exists();
	}

	public static void createNewFile(File inpFileObj) throws CustomException {
		try {
			if (!validateFileExists(inpFileObj)) {
				inpFileObj.createNewFile();
			}
