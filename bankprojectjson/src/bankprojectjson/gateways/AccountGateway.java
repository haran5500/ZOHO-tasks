...
//	public static JSONObject customerIDObject=new JSONObject();
	public static JSONObject accIDJson = new JSONObject();
	// deals with customerData json
	...
	public JSONObject fetchCustomerJSON(AccountData account) throws CustomException {
	...
	public void updateCustomerAccounts(AccountData account) throws CustomException {
		Validator.validateObject(account);
...
//			}
	...
	public List<AccountData> getListOfAccounts(JSONObject inpObj) throws CustomException {
		List<AccountData> accountList = new ArrayList<AccountData>();
	...
	public JSONObject getJSONCustomerAccountByID(long customerID) throws CustomException {
		CheckerUtil.checkCustomerID(customerID);
	...
	public List<AccountData> getAccountsByStatus(long customerID, boolean boolValue) throws CustomException {
		CheckerUtil.checkCustomerID(customerID);
