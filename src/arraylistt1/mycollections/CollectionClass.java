...
public String[] getElementsInRange(String[] srcArray,int start,int end)throws Exception
{
	validateObject(srcArray);
	
	checker.checkNumberNegative(start);
	checker.checkNumberNegative(end);
	
	int length=srcArray.length;
	checker.arrayLengthCheck(length,start);
	checker.arrayLengthCheck(length,end);
